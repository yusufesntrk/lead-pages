// ===== SCROLL-DRIVEN CAR =====
// Erster Scroll → Auto bewegt sich. Auto weg → Seite scrollt normal.
// Hero: position:fixed während Animation, position:absolute danach (scrollt weg).
// Kein Fade, kein Blank – nahtloser Übergang.
(function () {
  ...
  function update() {
    ...
    // Position-Switch: fixed während Animation → absolute wenn fertig
    ...
    // Auto: startet halb links, fährt komplett nach rechts raus
